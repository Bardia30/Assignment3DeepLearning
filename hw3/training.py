...
from ee8223.train_results import FitResult, BatchResult, EpochResult
...
class ClassifierTrainer(Trainer):
    ...
    def train_batch(self, batch) -> BatchResult:
        ...
        batch_loss = self.loss_fn(outputs, y)
        ...
        return BatchResult(loss=batch_loss.item(), num_correct=num_correct)
