...
class Classifier(nn.Module, ABC):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        z = self.model(x)
        if z is None:
            raise ValueError("Wrapped model returned None in forward pass.")
        # ========================
    ...
    def classify(self, x: Tensor) -> Tensor:
        ...
        """
        # TODO: Implement the classify logic using probabilities.
        # ====== YOUR CODE: ======
    ...
    def classify_scores(self, z: Tensor) -> Tensor:
        ...
        :returns: (N,) tensor of type torch.int containing predicted class labels.
        """
        # TODO: Implement classification directly from raw scores.
        # ====== YOUR CODE: ======
        y_proba = self.predict_proba_scores(z)
        return self._classify(y_proba)
        # ========================
    ...
    def _classify(self, y_proba: Tensor) -> Tensor:
        """
        Abstract method to classify samples based on probability scores.
